          ...
          >
            ...
            newQuestion.model == "Combined" ? (
              <div>
                ...
                {!allImage.quest_image ? !newQuestion.question.quest.image ? null : <img  style={{
                      height: 100,
                      width: 120,
                      padding: 2,
                      borderRadius: 5,
                    }}
                    src={newQuestion.question.quest.image}></img> : (
                  <img
                    style={{
                      height: 100,
                      width: 120,
          ...
          >
            ...
            newQuestion.model == "Combined" ? (
              <div>
                ...
                {!allImage.optionA ? !newQuestion.question.options[0].image ? null : <img style={{
                      height: 100,
                      width: 120,
                      padding: 2,
                      borderRadius: 5,
          ...
          >
            ...
            newQuestion.model == "Combined" ? (
              <div>
                ...
                {!allImage.optionB ? !newQuestion.question.options[1].image ? null : <img style={{
                      height: 100,
                      width: 120,
                      padding: 2,
                      borderRadius: 5,
          ...
          >
            ...
            newQuestion.model == "Combined" ? (
              <div>
                ...
                {!allImage.optionC ? !newQuestion.question.options[2].image ? null : <img style={{
                      height: 100,
                      width: 120,
                      padding: 2,
                      borderRadius: 5,
          ...
          >
            ...
            newQuestion.model == "Combined" ? (
              <div>
                ...
                {!allImage.optionD ?!newQuestion.question.options[3].image ? null : <img style={{
                      height: 100,
                      width: 120,
                      padding: 2,
                      borderRadius: 5,
